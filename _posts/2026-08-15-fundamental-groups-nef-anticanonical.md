...
title_ja: "反標準束がnefなコンパクトKähler多様体の基本群"
...
arxiv_updated: "2026-02-07"
summary: >-
  nefな反対数標準因子をもつ特異コンパクトKähler多様体について、基本群がほとんど可換になる条件を与える。
  lc対、三次元klt空間、Fujiki類におけるAlbanese写像を、Kähler RCD空間の理論と結びつける。
abstract_en: ""
summary_en: >-
  The paper studies almost-abelian fundamental groups beyond the smooth Kähler setting with nef anticanonical bundle. For log-canonical pairs on klt Kähler spaces, it proves the expected conclusion under a stated Kähler-RCD conjecture and establishes unconditional smooth and three-dimensional cases. A pseudoeffective variant is obtained under an asymptotic singularity condition. The work also proves surjectivity and connectedness for resolved Albanese maps in Fujiki class C.
abstract_ja: >-
...
abstract_source_url: "https://arxiv.org/abs/2602.07420v1"
...
## 書誌情報
- **arXiv:** [arXiv:2602.07420v1](https://arxiv.org/abs/2602.07420v1)
